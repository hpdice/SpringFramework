...
// EMS 개발 연도 , 개발자 , 버전 등의 정보를 담은 클래스 
...
public class EMSInformationService {
	...
	private Map<String, String> adminstrators;
	...
	public void printEMSInformation() {
		...
		System.out.println("Adminstrator: " + adminstrators);
		printDBInfo();
	...
	public Map<String, String> getAdminstrators() { return adminstrators; }
	public void setAdminstrators(Map<String, String> adminstrators) { this.adminstrators = adminstrators; }
